...
<body>
    <form id="form1" runat="server">
     <div class="card w-50 m-auto mt-4 p-2 border-danger">
            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="rfvFullName" runat="server" ErrorMessage="Enter Full Name" ControlToValidate="txtFullName" Display="Dynamic" ForeColor="#CC0000"></asp:RequiredFieldValidator>
                ...
                <div class="col-12 text-center mt-1">
                    <hr />
                    Already registered?
                <asp:HyperLink ID="hlLogin" NavigateUrl="~/Default.aspx" runat="server">Login</asp:HyperLink>
                </div>
            </div>
        </div>
    </form>
